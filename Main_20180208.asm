...
cmd_wait:
	...
	breq init_recv	; по таймауту переходим на переинициализацию приема
	
	rjmp cmd_wait	; продолжаем ждать
...
check_next3:
	...
	cbi PORTB, PORTB2	; ВКЛючаем питание Bluetooth Audio модуля
	rjmp cmd_send
...
check_next4:
	...
	sbi PORTB, PORTB2	; ВЫКЛючаем питание Bluetooth Audio модуля
	rjmp cmd_send
...
init:
	...
	out DDRB, r19
	sbi PORTB, PORTB2	; питание Bluetooth Audio модуля выключено

	; установка режима Idle для SLEEP и 
	; прерывния по нарастающему фронту на INT0
