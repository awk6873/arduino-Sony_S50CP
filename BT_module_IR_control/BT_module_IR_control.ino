#include <IRremote.h>
// Программа для управления BT аудио модулем KRC-86B пультом ДУ от магнитолы Sony ZS-S50CP
// ATtiny85 9.6 МГц
// Дата последней модификации 15.03.2018
...
// длительность короткого "нажатия", мс
int PRESS_DELAY = 100;
